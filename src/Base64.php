...
final class Base64
{
     ...
     * character.
     *
     * @throws MalformedArgumentException when $value is not valid Base64
     */
    public static function decode(string $value): string
    {
        $result = base64_decode($value, true);
        if ($result === false) {
            throw new MalformedArgumentException('Invalid base64 input.');
        }
     ...
     * decoding.
     *
     * @throws MalformedArgumentException when $value is not valid URL-safe Base64
     */
    public static function decodeUrl(string $value): string
    {
        ...
        if ($result === false) {
            throw new MalformedArgumentException('Invalid base64url input.');
        }
